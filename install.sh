...
"https://raw.githubusercontent.com/SaltwaterC/romanian-programmers-mac/non-standard/uk/Romanian%20-%20Programmers.icns" \
--output "/Library/Keyboard Layouts/Romanian - Programmers.icns"
	echo "» Instalez Romanian - Programmers ${layout}.keylayout"
	sudo curl --silent --location --max-redirs 10 \
"https://raw.githubusercontent.com/SaltwaterC/romanian-programmers-mac/non-standard/uk/Romanian%20-%20Programmers%20${layout}.keylayout" \
